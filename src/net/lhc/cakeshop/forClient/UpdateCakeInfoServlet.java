...
/**
 * Servlet implementation class UpdateCakeInfoServlet
 */
@WebServlet("/updateCakeInfo")
public class UpdateCakeInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateCakeInfoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        //将json数据转为String
        Gson gson = new Gson();
        Cake cake =gson.fromJson(stringBuffer.toString(), Cake.class);
        
        boolean b = false;
        
      
        
        //调用CakeService类中addCake方法访问数据库，并返回查询结果
        CakeService cakeService = new CakeService();
        
        b = cakeService.updateCake(cake);
