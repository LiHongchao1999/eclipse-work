...
/**
 * Servlet implementation class UpdateNewCakeServlet
 */
@WebServlet("/submitCake")
public class SubmitNewCakeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubmitNewCakeServlet() {
        super();
