...
import net.lhc.cakeshop.services.AdminService;
import net.lhc.cakeshop.services.UserService;
...
public class AdminLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        //将json数据转为String
        Gson gson = new Gson();
        Admin admin =gson.fromJson(stringBuffer.toString(), Admin.class);
        
        boolean b = false;
        
        //调用AdminService类中isExistAdmin方法访问数据库，并返回查询结果
        AdminService adminService = new AdminService();
        b = adminService.isExistAdmin(admin);
