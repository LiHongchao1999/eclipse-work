...
/**
 * Servlet implementation class UpdateOrderTagServlet
 */
@WebServlet("/updateOrderTag")
public class UpdateOrderTagServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateOrderTagServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        //将json数据转为Order
        Gson gson = new Gson();
        Order order =gson.fromJson(stringBuffer.toString(), Order.class);
        System.out.println(order.toString());
        
      //调用OrderService类中updateOrder方法访问数据库，并返回查询结果
